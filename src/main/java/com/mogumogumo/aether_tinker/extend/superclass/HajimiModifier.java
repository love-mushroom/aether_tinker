package com.mogumogumo.aether_tinker.extend.superclass;
...
public class HajimiModifier extends BattleModifier implements EquipmentChangeModifierHook, InventoryTickModifierHook, OnAttackedModifierHook, TooltipModifierHook, ModifyDamageModifierHook, ModifierRemovalHook, BlockBreakModifierHook, EntityInteractionModifierHook, ToolStatsModifierHook {
    @Override
